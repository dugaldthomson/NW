function [figure_handle,count,speeds,directions,Table] = rangeRoser(direction,speed,varargin)
    %% WindRose
...
circlemax        = [];
FreqLabelAngle   = [];
TitleString      = {'Histogram of contact ranges';' '};
lablegend        = 'Contact ranges in km';
colorfun         = 'jet';
